...
/*    @GetMapping("/send")
    ...
    @PostMapping
    public String addNotif(@RequestParam String phone, @RequestParam String notif, @RequestParam String urladdress) {
        EmulatorRequest emulatorRequest = new EmulatorRequest();
        emulatorRequest.phone = phone.substring(2);
        emulatorRequest.notif = notif;
        Crutch.er = emulatorRequest;
        Crutch.urladdress = urladdress;
        Crutch.flagSender = false;
        return "main";
    }
}
